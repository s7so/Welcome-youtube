...
### **الصفحات والمكونات:**
- **لوحة التحكم**: نظرة عامة مع إحصائيات ورسوم بيانية
- **إدارة الموظفين**: عمليات CRUD كاملة مع البحث والفلترة
- **إدارة الأقسام**: إدارة الهيكل التنظيمي
- **تتبع الحضور**: سجلات الحضور في الوقت الفعلي مع المزامنة
- **التقارير**: تقارير شاملة مع رسوم بيانية تفاعلية وتصدير
- **الإعدادات**: تكوين النظام مع تبويبات متعددة والتكاملات
...
├── departments/
│   └── department_list.html # صفحة إدارة الأقسام
├── attendance/
│   └── attendance_list.html # صفحة الحضور والانصراف
├── reports/
